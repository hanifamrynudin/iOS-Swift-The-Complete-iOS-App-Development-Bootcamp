...
struct StoryBrain {
    ...
    func getChoose1() -> String {
        return stories[storyNumber].choice1
    }
    
    func getChoose2() -> String {
        return stories[storyNumber].choice2
    }
    
    mutating func nextStory(userChoice: String) {
        print("pressed!")
        let currentChoice = stories[storyNumber]
        if userChoice == currentChoice.choice1 {
            storyNumber = currentChoice.choice1Destination
        } else if userChoice == currentChoice.choice2 {
            storyNumber = currentChoice.choice2Destination
        }
        print("pressed!")
    }
